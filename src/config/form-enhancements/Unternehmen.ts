...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["firmenname", {"row": ["strasse", "hausnummer"], "cols": "2fr 1fr"}, {"row": ["plz", "ort"], "cols": "1fr 2fr"}, "laender", {"row": ["ansprechpartner_vorname", "ansprechpartner_nachname"]}, "ansprechpartner_email", "ansprechpartner_telefon", "steuernummer", "epr_registrierungsnummern", {"row": ["verantwortlich_vorname", "verantwortlich_nachname"]}, "verantwortlich_funktion", "verantwortlich_email"],
  defaults: {},
  computed: {},
};
