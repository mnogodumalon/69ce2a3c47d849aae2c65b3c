// Auto-generated. Per-entity form-enhancements config for "Regelstatus".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["verpackungstyp_status_ref", "konformitaetsstatus", "datanluecke_flag", "problemfelder", "status_kommentar", "bewertungsdatum", {"row": ["bewerter_vorname", "bewerter_nachname"]}, "bewerter_abteilung"],
  defaults: {},
  computed: {},
};
